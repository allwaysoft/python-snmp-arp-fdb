...
if __name__ == "__main__":
    ...
    atPhysAddress = snmp_walk('10.48.190.220', '1.3.6.1.2.1.3.1.1.2', 'hex', community='dccz2019')
    ...
    dot1dBasePortIfIndex = snmp_walk('10.48.190.220', '1.3.6.1.2.1.17.1.4.1.2', 'int', community='dccz2019')
    dot1dBasePort = {}
    ...
    ifDescr = snmp_walk('10.48.190.220', '1.3.6.1.2.1.2.2.1.2', 'str', community='dccz2019')
    Descr = {}
    ...
    dot1qTpFdbPort = snmp_walk('10.48.190.220', '1.3.6.1.2.1.17.4.3.1.2', 'int', community='dccz2019')
    dot1qTpFdb = {}
