...
if __name__ == "__main__":
    ...
    atPhysAddress = snmp_walk('10.48.190.252', '1.3.6.1.2.1.3.1.1.2', 'hex', community='DCCZ310')
    ...
    dot1dBasePortIfIndex = snmp_walk('10.48.190.252', '1.3.6.1.2.1.17.1.4.1.2', 'int', community='DCCZ310')
    dot1dBasePort = {}
    ...
    ifDescr = snmp_walk('10.48.190.252', '1.3.6.1.2.1.2.2.1.2', 'str', community='DCCZ310')
    Descr = {}
    ...
    dot1qTpFdbPort = snmp_walk('10.48.190.252', '1.3.6.1.2.1.17.4.3.1.2', 'int', community='DCCZ310')
    dot1qTpFdb = {}
